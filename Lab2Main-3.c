...
int main(void) {
    ...
    SPI1CONbits.MSTEN = 1; // Set to master.
    SPI1CONbits.MSSEN = 1; // Leader Follower select
    ...
    // Set SPI for 16 bit communication
    ...
    // Must wait for space to open in the register (previous data has filled it)
